...
<template>
  <section>
    <h1>Style Guide</h1>
    <p>
      This page is filled with common HTML elements to be used to provide visual feedback
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>Content Goes Here</td>
          <td>
            This is longer Content Goes Here Donec id elit non mi porta gravida at eget
            metus.
          </td>
          <td>Content Goes Here</td>
          <td>Content Goes Here</td>
  ...
  <section id="embedded-video">
    ...
    <video controls="">
      ...
      />
      <source
        src="https://html5demos.com/assets/dizzy.webm"
        type="video/webm"
      />
      <source
        src="https://html5demos.com/assets/dizzy.ogv"
        type="video/ogg"
      />
