export default function getMetaData(pageName, data) {
  ...
  return {
    ...
    meta: [
      ...
      { name: 'og:description', content: data[0].description },
      { name: 'og:image', content: data[0].image },
      ...
      { name: 'twitter:description', content: data[0].description },
      { name: 'twitter:image', content: data[0].image }
    ]
  }
};
